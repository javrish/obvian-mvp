...
class PetriToDagProjectorTest {
    ...
    class BasicProjectionTests {
        ...
        void shouldProjectSimpleLinearWorkflow() {
            ...
            PetriNet petriNet = PetriNet.builder()
                    ...
                    .addTransition(new Transition("t1", "Start Task", null, "start", null, new HashMap<>()))
        ...
        void shouldHandlePlacesWithMultipleProducersOrConsumers() {
            ...
            PetriNet petriNet = PetriNet.builder()
                    ...
                    .addTransition(new Transition("t2", "Target1", null, "target1", null, new HashMap<>()))
                    .addTransition(new Transition("t3", "Target2", null, "target2", null, new HashMap<>()))
                    .addArc("t1", "p1", 1)
                    .addArc("p1", "t2", 1)
                    .addArc("p1", "t3", 1)
                    .build();
    ...
    class DevOpsScenarioTests {
        ...
        void shouldProjectCiCdPipelineWorkflow() {
            ...
            PetriNet cicdNet = PetriNet.builder()
                    .name("DevOps CI/CD Pipeline")
                    .description("Automated deployment pipeline")
                    // Places (intermediate states)
                    .addPlace(new Place("source_ready", "Source Code Ready", null, null, new HashMap<>()))
                    .addPlace(new Place("build_complete", "Build Artifacts Ready", null, null, new HashMap<>()))
                    ...
                    .addTransition(createDevOpsTransition("build", "Build Application", "docker_build", buildParams))
                    .addTransition(createDevOpsTransition("test", "Run Tests", "pytest", testParams))
                    .addTransition(createDevOpsTransition("deploy", "Deploy to Staging", "kubernetes_deploy", deployParams))
        ...
        void shouldProjectInfrastructureDeploymentWorkflow() {
            ...
            PetriNet infraNet = PetriNet.builder()
                    .name("Infrastructure Deployment")
                    .addPlace(new Place("plan_ready", "Terraform Plan Ready", null, null, new HashMap<>()))
                    ...
                    .addTransition(createDevOpsTransition("plan", "Terraform Plan", "terraform_plan", null))
                    .addTransition(createDevOpsTransition("validate", "Validate Plan", "terraform_validate", null))
                    .addTransition(createDevOpsTransition("apply", "Apply Infrastructure", "terraform_apply", null))
                    .addTransition(createDevOpsTransition("verify", "Verify Deployment", "health_check", null))
        ...
        private Transition createDevOpsTransition(String id, String name, String action, Map<String, Object> params) {
    ...
    class FootballScenarioTests {
        ...
        void shouldProjectMatchPreparationWorkflow() {
            ...
            PetriNet footballNet = PetriNet.builder()
                    .name("Match Preparation Workflow")
                    .description("Complete match preparation process")
                    // Places
                    .addPlace(new Place("opponent_analyzed", "Opponent Analysis Complete", null, null, new HashMap<>()))
                    .addPlace(new Place("tactics_planned", "Tactical Plan Ready", null, null, new HashMap<>()))
                    .addPlace(new Place("team_trained", "Team Training Complete", null, null, new HashMap<>()))
                    .addPlace(new Place("squad_selected", "Starting XI Selected", null, null, new HashMap<>()))
                    // Transitions
                    .addTransition(createFootballTransition("scout", "Scout Opponent", "opponent_analysis", scoutParams))
                    .addTransition(createFootballTransition("plan", "Plan Tactics", "tactical_planning", planParams))
                    .addTransition(createFootballTransition("train", "Team Training", "training_session", trainParams))
                    .addTransition(createFootballTransition("select", "Team Selection", "squad_selection", null))
                    .addTransition(createFootballTransition("match", "Play Match", "match_execution", null))
                    // Workflow arcs
        ...
        void shouldProjectPlayerTransferWorkflow() {
            ...
            PetriNet transferNet = PetriNet.builder()
                    .name("Player Transfer Process")
                    .addPlace(new Place("target_identified", "Transfer Target Identified", null, null, new HashMap<>()))
                    .addPlace(new Place("terms_agreed", "Contract Terms Agreed", null, null, new HashMap<>()))
                    .addPlace(new Place("medical_passed", "Medical Examination Passed", null, null, new HashMap<>()))
                    .addTransition(createFootballTransition("identify", "Identify Target", "player_scouting", null))
                    .addTransition(createFootballTransition("negotiate", "Negotiate Transfer", "contract_negotiation", null))
                    .addTransition(createFootballTransition("medical", "Medical Check", "medical_examination", null))
                    .addTransition(createFootballTransition("announce", "Announce Transfer", "media_announcement", null))
        ...
        private Transition createFootballTransition(String id, String name, String action, Map<String, Object> params) {
            Map<String, Object> metadata = new HashMap<>();
            if (params != null) {
                metadata.put("inputParams", params);
            }
    ...
    class ComplexWorkflowTests {
        ...
        void shouldHandleChoiceTransitions() {
            ...
            Transition reviewTransition = new Transition("review", "Review Code", null, "code_review", null, new HashMap<>());
            Transition approveTransition = Transition.builder("approve")
                    .name("Approve PR")
                    .action("approve_merge")
                    .asChoice("status == 'approved'")
                    .build();
            Transition rejectTransition = Transition.builder("reject")
                    .name("Reject PR")
                    .action("reject_merge")
                    .asChoice("status == 'rejected'")
                    .build();

            PetriNet choiceNet = PetriNet.builder()
            ...
            assertThat(approveNode.getMetadata()).containsEntry("choiceCondition", "status == 'approved'");
        }
        ...
        void shouldHandleForkJoinPatterns() {
            ...
            PetriNet parallelNet = PetriNet.builder()
                    ...
                    .addTransition(Transition.builder("start").name("Start Work").action("initialize").asFork().build())
                    .addTransition(new Transition("task1", "Task 1", null, "execute_task1", null, new HashMap<>()))
                    .addTransition(new Transition("task2", "Task 2", null, "execute_task2", null, new HashMap<>()))
                    .addTransition(Transition.builder("join").name("Join Results").action("combine_results").asJoin().build())
            ...
            assertThat(endNode.getDependencyIds()).containsExactly("join"); // Only join -> end edge projected
        }
        ...
        void shouldPreserveOriginalTransitionMetadata() {
            ...
            Transition transition = new Transition("custom", "Custom Task", "Custom description", "custom_action", "guard_condition", customMetadata);

            PetriNet simpleNet = PetriNet.builder()
                    .name("Simple Net")
    ...
    class EdgeCasesAndErrorHandling {
        ...
        void shouldHandleEmptyWorkflowGracefully() {
            PetriNet emptyNet = PetriNet.builder()
                    ...
                    .addTransition(new Transition("orphan", "Orphan Transition", null, "orphan_action", null, new HashMap<>()))
                    .build(); // No arcs
        ...
        void shouldHandleTransitionsWithNullOrEmptyActions() {
            PetriNet actionTestNet = PetriNet.builder()
                    .name("Action Test")
                    .addTransition(new Transition("null_action", "Null Action", null, null, null, new HashMap<>()))
                    .addTransition(new Transition("empty_action", "Empty Action", null, "", null, new HashMap<>()))
                    .addTransition(new Transition("whitespace_action", "Whitespace Action", null, "  ", null, new HashMap<>()))
                    .build();
        ...
        void shouldHandleTransitionsWithNullNames() {
            PetriNet nullNameNet = PetriNet.builder()
                    .name("Null Name Test")
        ...
        void shouldMaintainDeterministicOrderingWithLexicographicSorting() {
            ...
            PetriNet orderingNet = PetriNet.builder()
                    .name("Ordering Test")
                    ...
                    .addTransition(new Transition("z_task", "Z Task", null, "z_action", null, new HashMap<>()))
                    .addTransition(new Transition("a_task", "A Task", null, "a_action", null, new HashMap<>()))
                    .addTransition(new Transition("m_task", "M Task", null, "m_action", null, new HashMap<>()))
                    .addTransition(new Transition("final", "Final", null, "final_action", null, new HashMap<>()))
                    .addArc("z_task", "p1", 1)
                    .addArc("p1", "a_task", 1)
                    .addArc("a_task", "p2", 1)
                    .addArc("p2", "m_task", 1)
            ...
            assertThat(dag1.getNode("a_task").getDependencyIds()).isEqualTo(dag2.getNode("a_task").getDependencyIds());
            assertThat(dag1.getNode("m_task").getDependencyIds()).isEqualTo(dag2.getNode("m_task").getDependencyIds());
            assertThat(dag1.getNode("final").getDependencyIds()).isEqualTo(dag2.getNode("final").getDependencyIds());
        }
    }
}