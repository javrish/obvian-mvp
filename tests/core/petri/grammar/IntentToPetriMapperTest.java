...
class IntentToPetriMapperTest {
  ...
  class ActionStepMapping {
    ...
    void mapSimpleActionStepCreatesPattern() {
      ...
      PetriIntentSpec.IntentStep actionStep =
    ...
    void mapActionStepWithGuardCondition() {
      ...
      PetriIntentSpec.IntentStep guardedStep =
          new PetriIntentSpec.IntentStep(
              "guarded_action",
              PetriIntentSpec.StepType.ACTION,
              "Guarded action",
    ...
    void mapActionStepWithDependencies() {
      ...
      PetriIntentSpec.IntentStep dependency =
          new PetriIntentSpec.IntentStep(
              "dep_action",
              PetriIntentSpec.StepType.ACTION,
              "Dependency action",
      ...
      PetriIntentSpec.IntentStep dependentStep =
          new PetriIntentSpec.IntentStep(
              "dependent_action",
              PetriIntentSpec.StepType.ACTION,
              "Dependent action",
              Arrays.asList("dep_action"),
              new HashMap<>(),
              null,
              new HashMap<>());
    ...
    void mapActionStepWithNoDependenciesGetsInitialToken() {
      ...
      PetriIntentSpec.IntentStep startStep =
          new PetriIntentSpec.IntentStep(
              "start_action",
              PetriIntentSpec.StepType.ACTION,
              "Start action",
  ...
  class ParallelStepMapping {
    ...
    void mapParallelStepCreatesANDSplit() {
      ...
      List<Place> places = petriNet.getPlaces();
      long branchPlaces =
          places.stream().filter(p -> p.getMetadata().containsKey("branchIndex")).count();
    ...
    void configureMapperWithMinimalNaming() {
      ...
      PetriIntentSpec.IntentStep actionStep =
          new PetriIntentSpec.IntentStep(
              "test_action",
              PetriIntentSpec.StepType.ACTION,
              "Very long description that should be shortened in descriptive mode",
              new ArrayList<>(),
              new HashMap<>(),
              null,
              new HashMap<>());
  ...
  class ContextManagement {
    ...
    void contextGeneratesUniqueIDsForMultipleSteps() {
      ...
      PetriIntentSpec.IntentStep step1 =
          new PetriIntentSpec.IntentStep(
              "step1",
              PetriIntentSpec.StepType.ACTION,
              "Step 1",
      ...
      PetriIntentSpec.IntentStep step2 =
          new PetriIntentSpec.IntentStep(
              "step2",
              PetriIntentSpec.StepType.ACTION,
              "Step 2",
  ...
  class EdgeCasesAndErrorHandling {
    ...
    void mapStepWithNullTypeThrowsException() {
      ...
      PetriIntentSpec.IntentStep nullTypeStep =
          new PetriIntentSpec.IntentStep(
              "null_type",
              null,
              "Null type step",
    ...
    void mapSequenceStepHandlesGracefully() {
      ...
      PetriIntentSpec.IntentStep sequenceStep =
          new PetriIntentSpec.IntentStep(
              "sequence1",
              PetriIntentSpec.StepType.SEQUENCE,
              "Sequential flow",
              new ArrayList<>(),
              new HashMap<>(),
              null,
    ...
    void mapStepWithCircularDependencyHandlesGracefully() {
      ...
      PetriIntentSpec.IntentStep stepWithBadDep =
          new PetriIntentSpec.IntentStep(
              "bad_dep_step",
              PetriIntentSpec.StepType.ACTION,
              "Bad dependency",
              Arrays.asList("non_existent_step"),
              new HashMap<>(),
              null,
              new HashMap<>());
