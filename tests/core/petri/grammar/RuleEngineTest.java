...
class RuleEngineTest {
        ...
        void applyParallelJoinRulesCreatesImplicitJoin() {
            ...
            PetriIntentSpec intentSpec = PetriIntentSpec.builder()
                    ...
                    .addStep(new PetriIntentSpec.IntentStep(
                            "parallel1", PetriIntentSpec.StepType.PARALLEL, "Parallel task",
    ...
    class ChoiceMergeRules {
        ...
        void applyChoiceMergeRulesForConvergentChoices() {
            ...
            List<Transition> mergeTransitions = petriNet.getTransitions().stream()
                    .filter(t -> Boolean.TRUE.equals(t.getMetadata().get("generated")))
    ...
    class DebugMetadata {
        ...
        void addDebugMetadataWhenEnabled() {
            ...
            Map<String, Object> stats = (Map<String, Object>) petriNet.getMetadata().get("transformationStats");
    ...
    class ConfigurationManagement {
        ...
        void configureRuleEngineUpdatesConfiguration() {
            ...
            assertThatCode(() -> ruleEngine.configure(config))
    ...
    class ErrorHandlingAndEdgeCases {
        ...
        void applyRulesWithEmptyContextHandlesGracefully() {
            ...
            PetriIntentSpec emptyIntent = PetriIntentSpec.builder()
                    .name("Empty Intent")
                    .build();
    ...
    private PetriIntentSpec createSequentialIntentSpec() {
        PetriIntentSpec.IntentStep action2 = new PetriIntentSpec.IntentStep(
                "action2", PetriIntentSpec.StepType.ACTION, "Second action",
    ...
    private PetriIntentSpec createParallelSyncIntentSpec() {
        PetriIntentSpec.IntentStep syncStep = new PetriIntentSpec.IntentStep(
                "sync1", PetriIntentSpec.StepType.SYNC, "Sync step",
        ...
        return PetriIntentSpec.builder()
                ...
                .addStep(new PetriIntentSpec.IntentStep(
                        "parallel1", PetriIntentSpec.StepType.PARALLEL, "Parallel step",
                        new ArrayList<>(), new HashMap<>(), null, new HashMap<>()
                ))
                .addStep(syncStep)
                .build();
    ...
    private PetriIntentSpec createChoiceWithDependentsSpec() {
        ...
        PetriIntentSpec.IntentStep dependent1 = new PetriIntentSpec.IntentStep(
                "dep1", PetriIntentSpec.StepType.ACTION, "Dependent 1",
                Arrays.asList("choice1"), new HashMap<>(), null, new HashMap<>()
        );

        PetriIntentSpec.IntentStep dependent2 = new PetriIntentSpec.IntentStep(
                "dep2", PetriIntentSpec.StepType.ACTION, "Dependent 2",
                Arrays.asList("choice1"), new HashMap<>(), null, new HashMap<>()
        );
        ...
        return PetriIntentSpec.builder()
                ...
                .addStep(new PetriIntentSpec.IntentStep(
                        "choice1", PetriIntentSpec.StepType.CHOICE, "Choice step",
    ...
    private void addParallelStructure(String stepId, AutomationGrammar.TransformationContext context,
    ...
    private void addSyncStructure(String stepId, AutomationGrammar.TransformationContext context,
                                 PetriNet.Builder builder) {
    ...
    private void addChoiceStructure(String stepId, AutomationGrammar.TransformationContext context,
                                   PetriNet.Builder builder) {
        String prePlaceId = "place_" + stepId + "_pre";
        ...
        Transition choice1Transition = Transition.builder(choice1TransitionId)
                .name(stepId + " choice 1")
                .asChoice("condition1")
                .build();

        Transition choice2Transition = Transition.builder(choice2TransitionId)
